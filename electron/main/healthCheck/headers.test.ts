...
describe('DEFAULT_TEST_MODEL', () => {
  ...
  it('其余三项非空', () => {
    expect(DEFAULT_TEST_MODEL.openai).toBe('gpt-4o-mini')
    expect(DEFAULT_TEST_MODEL.anthropic).toBe('claude-3-5-haiku-latest')
    expect(DEFAULT_TEST_MODEL.deepseek).toBe('deepseek-chat')
  })
})
